          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              {productos
                  ...
                  .sort((a, b) => {
                    // función para extraer el primer número del nombre
                    const extractFirstNumber = (s?: string): number => {
                      if (!s) return NaN
                    ...
                    const na = extractFirstNumber(a.nombre)
                    const nb = extractFirstNumber(b.nombre)
