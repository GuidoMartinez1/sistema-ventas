              ...
              <div className="bg-orange-50 p-4 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-orange-900">{compras.length}</p>
                  </div>
                </div>
              </div>
              <div className="bg-red-50 p-4 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-red-900">${calcularTotalCompras(compras).toLocaleString()}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                ...
                <span className={`font-bold ${
                  (stats.total_ventas_monto - stats.total_compras_monto) >= 0 
                    ? 'text-green-900' 
                    : 'text-red-900'
                }`}>
