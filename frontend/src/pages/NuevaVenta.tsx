...
// Ajuste leve: agregué focus ring naranja para coincidir con tu sistema, pero estructura original
...
// Helper para iconos (Estilos neutros para no invadir)
...
const NuevaVenta = () => {
    ...
    // Estado para la categoría seleccionada (null = ninguna seleccionada)
    ...
    // --- LÓGICA DE FILTRADO (Productos Ocultos por defecto) ---
    const productosVisibles = useMemo(() => {
        // 1. Si hay búsqueda, mostramos coincidencias (ignora categorías)
        if (busqueda) {
        ...
        // 2. Si NO hay búsqueda y NO hay categoría seleccionada, NO mostramos nada
        if (categoriaSeleccionada === null) {
            return [];
        }

        // 3. Si hay categoría seleccionada, filtramos por ella
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    const addNuevoItem = () => { /* ... Lógica original preservada ... */ }
    ...
    return (
        <div className="p-4 md:p-8 space-y-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                ...
                <div className="lg:col-span-2 space-y-6 no-print">
                    ...
                    <div className={cardClass}>
                        ...
                        {/* CAJITAS DE CATEGORÍAS (Se ocultan si buscás) */}
                        {!busqueda && (
                ...
                {/* COLUMNA DERECHA: CARRITO (CÓDIGO ORIGINAL PURO) */}
            ...
            {/* TICKETS (Ocultos) - Igual que siempre */}
