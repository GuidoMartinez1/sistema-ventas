        ...
        setCartItems(prev => {
            ...
            if (existingItem) {
                ...
                const newItem: DetalleCompra = {
                    ...
                    cantidad: 1,
                    // Usamos el costo actual como precio inicial de compra
                                ...
                                <Tag className='h-3 w-3 mr-1'/> {producto.categoria_nombre}
                                            ...
                                            <div className="grid grid-cols-3 gap-2 bg-white p-2 rounded border">
                                                ...
                                                <div className="text-center">
                                                    ...
                                                    {/* 💡 REFACTORIZACIÓN: Cambiamos type="number" a type="text" y ajustamos el manejo de valores */}
                                                    <input
                                                        type="text" // Cambiado a text para eliminar las flechas
                                                        value={item.precio_unitario || ''} // Aseguramos que sea string, si es null/undefined, es string vacío
                                                        onChange={(e) => {
                                                            // Limpiamos caracteres no numéricos o decimales incorrectos
                                                            const rawValue = e.target.value.replace(/[^0-9.]/g, '')
                                                            // Convertimos a número antes de llamar a la función de actualización
                                                            updatePrecioUnitario(item.producto_id, parseFloat(rawValue) || 0)
                                                        }}
                            ...
                            <form onSubmit={handleCreateProduct} className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        {/* Se mantiene type="number" aquí, ya que no es el carrito */}
                                        <input
                                            type="number"
                                            step="0.01"
                                            required
