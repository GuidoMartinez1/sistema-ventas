...
const Ventas = () => {
    ...
    // CAMBIO 1: Lógica copiada de Reportes.tsx para obtener "Hoy" en hora local exacta
    const hoy = () => {
    ...
    const ventasFiltradas = ventas.filter((venta) => {
        ...
        // CAMBIO 2: Lógica copiada de Reportes.tsx (uso de en-CA para YYYY-MM-DD local)
        const fechaItem = new Date(venta.fecha)
        const fechaVenta = fechaItem.toLocaleDateString('en-CA') // Esto devuelve YYYY-MM-DD local
